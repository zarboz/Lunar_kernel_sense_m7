...
#if 0
static struct msm_gpiomux_config t6_ext_regulator_configs[] __initdata = {
	{
		.gpio = t6_EXT_3P3V_REG_EN_GPIO,
		.settings = {
...
#if 0
static struct msm_gpiomux_config t6_mxt_configs[] __initdata = {
	{	
		.gpio = 6,
		.settings = {
