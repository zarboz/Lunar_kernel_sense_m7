...
VREG_CONSUMERS(L9) = {
	...
	REGULATOR_SUPPLY("aud_vdd_L9",  NULL),
};
VREG_CONSUMERS(L10) = {
...
VREG_CONSUMERS(LVS2) = {
	...
	REGULATOR_SUPPLY("tfa9887_vdd_LVS2",NULL),
};
VREG_CONSUMERS(LVS3) = {
...
t6_rpm_regulator_init_data[] __devinitdata = {
...
int t6_pm8921_regulator_pdata_len __devinitdata =
	ARRAY_SIZE(t6_pm8921_regulator_pdata);

struct rpm_regulator_platform_data t6_rpm_regulator_pdata __devinitdata = {
	.init_data		= t6_rpm_regulator_init_data,
	.num_regulators		= ARRAY_SIZE(t6_rpm_regulator_init_data),
